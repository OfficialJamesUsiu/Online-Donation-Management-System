...
if($insertSuccess) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        $url = "http://localhost:8080/We-Support/donationProof.php?campaignId=".$campaignId."&donorId=".$row['donor_id'];
        $to = $email;
        ...
        $headers = "From: We-Support <ngangajames1995@gmail.com>\r\n";
        $headers .= "Reply-To: ngangajames1995@gmail.com\r\n";
