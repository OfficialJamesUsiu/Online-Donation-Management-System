    ...
    <div class="signupbox">
        ...
        <br>
            <form action="includes/createCampaign.inc.php" method="POST" enctype="multipart/form-data">
                ...
                <!-- Phone number formatting and placeholder -->
                <input type="tel" name="phone" placeholder="Phone: 07********" pattern="[0-9]{10}" required><br><br>
                ...
                <input type="checkbox" required><span id="agreeterms"> Agree to all terms and conditions</span><br>
